...
public class ConnectionPage extends Page {
	...
	public final static String PGR_DRIVER  = "com.is.util.db.driver.digestdriver.DigestDriver";
	
	//url prefixes
	private final static String URL_PGR_DRIVER_PREFIX = "digest:jdbc:postgresql://";
	...
	DB_TYPE dbType = DB_TYPE.ORCL;         //oracle default
...
/*    public  Connection getConnection(){
    	...
    	DataSourceFactoryBypass ds = new DataSourceFactoryBypass(prop);
